...
//
// https://github.com/OAuthSwift/OAuthSwift/tree/master/Sources
// Thanks Dongri for the swift implementation for hmac-sha1 
// CommonCrypto is not available for Swift linux 
